...
if ( ! function_exists( 'custom_taxonomy_company' ) ) {

// Register Custom Taxonomy
function custom_taxonomy_company() {
	...
	$labels = array(
		...
		'all_items'                  => __( 'Companies', 'text_domain' ),
	...
	register_taxonomy( 'company', array( 'post', 'product' ), $args );

}
add_action( 'init', 'custom_taxonomy_company', 0 );
